var SkyRTC = function() {
    ...
    skyrtc.prototype.connect = function(server, room,userid) {
        ...
        this.on('_new_peer', function(data) {
            ...
            that.userids[data.userId]=data.socketId;
            var pc = that.createPeerConnection(data.socketId),
                i, m;
            /**
             * add user to userlist
             */
            //var ul = document.getElementById('egoo-group-list-ul');
            //ul.innerHTML = '';
            //setTimeout(function () {
            //    for(i in that.peerConnections){
            //        $.ajax({
            ...
            //                initUserList(data.username+"new peer");
            //            }
            //        });
            //    }
            //},1);
        ...
        this.on('_notication', function (data) {
            alert(data.msg);
        });
    };
